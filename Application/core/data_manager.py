# A service to manage(load) image data for training.
import logging
import pickle
import os
import sys
...
class EmojifierLoader(object):
    def __init__(self, source_files):
        ...
        # _i is used as an iterator.
        self._i = 0
        #  _n stands for the number of images.
        self._n = 0
        self.images = None
        self.labels = None

    def load(self):
        # unpickling the data since it is binary. Therefore it needs to be pickled and later unpickled to serialize and maintain information.
