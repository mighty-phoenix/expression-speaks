...
def from_cam(sess):
    ...
    face_cascade = cv2.CascadeClassifier('/media/hackerpro/871501f2-df6c-4a21-a03c-8b8e22d001d4/PROJECTS/Expressions Speak/Application/App2/explo/lib/python3.6/site-packages/cv2/data/haarcascade_frontalface_default.xml')
...
if __name__ == '__main__':
    ...
    # It allows a value to be assigned later i.e. a place in the memory where we'll store a value later on.
